...
import com.yupi.yupicturebackend.auth.model.SpaceUserAuthContext;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    @Resource
    private SpaceService spaceApplicationService;

    @Resource
    private SpaceUserService spaceUserApplicationService;

    @Resource
    private PictureService pictureApplicationService;
